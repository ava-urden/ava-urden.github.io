const dict = {
  sv: {
    ...
    hero_body: "Som person är jag driven och målinriktad med ett kreativt tänk och stort intresse för design, men trivs lika mycket med data. Jag omsätter insikter till kreativa leveranser med strategisk grund.",
    cta_cases: "Se cases",
    cta_cv: "Ladda ner CV",
