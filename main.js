const dict = {
  sv: {
    ...
    hero_body: "Som person är jag driven och målinriktad med ett kreativt tänk och intresse för design, samtidigt trivs jag lika mycket med data. Jag omsätter insikter till kreativa leveranser med strategisk grund.",
    cta_cases: "Se cases",
    cta_cv: "Ladda ner CV",
  ...
  en: {
    ...
    nav_contact: "Contact",
    hero_title: "Ava Urdén",
    hero_body: "I am driven and goal-oriented with a creative mindset. I enjoy data and analysis just as much as design, translating insights into creative deliverables with a strategic foundation.",
